...
use App\Repositories\Implementations\ProdutosMaisVendidosRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ProdutosMaisVendidosRepositoryContract::class, ProdutosMaisVendidosRepository::class);
    }
